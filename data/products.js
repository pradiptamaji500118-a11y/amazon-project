  ...
  extraInfoHTML() {
    return `
      <div class="product-warranty">
        <a class="warranty-link link-primary" 
           href="images/appliance-warranty.png" 
           target="_blank">
          Warranty
        </a>
      </div>
...
class Shoes extends Product {
  extraInfoHTML() {
    return `
      <div class="shoes-size-chart">
        <a class="shoes-size-chart-link link-primary" 
           href="images/shoe-size-chart.png" 
           target="_blank">
          Size Chart
        </a>
      </div>
